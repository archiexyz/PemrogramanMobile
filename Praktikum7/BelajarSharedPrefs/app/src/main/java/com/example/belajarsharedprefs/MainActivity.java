...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String mSharedPrefFile = "com.example.belajarsharedprefs";
    @Override
