...
public class DashboardActivity extends AppCompatActivity {
    ...
    public void setDataItem(){
        ...
        listItem.add(new Item("Waduk Seloparang",R.drawable.waduk, 10000, String.valueOf(getText(R.string.detailProduk1))));
        listItem.add(new Item("Camping Ground",R.drawable.camping, 550000, String.valueOf(getText(R.string.detailProduk2))));
        listItem.add(new Item("Ayunan Gantung",R.drawable.ayunan, 125000, String.valueOf(getText(R.string.detailProduk3))));
        listItem.add(new Item("Flying Fox",R.drawable.terbang, 75000, String.valueOf(getText(R.string.detailProduk4))));
        listItem.add(new Item("Sepeda Angkasa",R.drawable.sepeda, 100000, String.valueOf(getText(R.string.detailProduk5))));
        listItem.add(new Item("Gardu Pandang", R.drawable.gardupandang,90000, String.valueOf(getText(R.string.detailProduk6))));
        listItem.add(new Item("Home Stay 3D2N", R.drawable.homestay,1750000, String.valueOf(getText(R.string.detailProduk7))));
    }
